...
const FAKE_DATA: ReportedProblem[] = [
  {
    id: 1,
    title: "Pothole on Main Street",
    description:
      "There is a large pothole on Main Street that is causing damage to cars.",
    status: "Open",
    date: "2021-06-01",
  ...
  },
  {
    ...
    description:
      "The street light on the corner of Elm Street and Maple Street is broken.",
    status: "In Progress",
    date: "2021-06-02",
